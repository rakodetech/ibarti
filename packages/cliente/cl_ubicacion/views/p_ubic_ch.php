...
<div id="Contenedor02">
	<table width="50%" border="0" align="center">
		<tr class="fondo01">
			...
			<th width="10%"><img src="imagenes/loading2.gif" alt="Agregar Registro" width="40" height="40" title="Agregar Registro" border="null" class="imgLink" /></th>
			<th width="10%">&nbsp;</th>
		</tr>
		<tr class="fondo02">
			<td id="input01_3" style="display:none"><input type="hidden" id="codigo_ubic" name="codigo_ubic" style="width:90px" value="<?php echo $codigo; ?>" /></td>
			...
			<td><span class="art-button-wrapper">
					...
					<input type="button" name="submit" id="submit" value="Agregar" class="readon art-button" onclick=" validarCampo('', 'agregar')" />
				</span></td>
		</tr>
		<tr>
			<td colspan="2" class="etiqueta_title">Listado</td>
		</tr>
		<?php
...
<script language="javascript" type="text/javascript">
	var input02_3 = new Spry.Widget.ValidationTextField("codigo_capta", "none", {
		minChars: 4,
	...
	for (i = 1; i < inc; i++) {
		var input02_3N = new Spry.Widget.ValidationTextField("codigo_capta" + i + "", "none", {
			minChars: 4,
			validateOn: ["blur", "change"]
		});
	}
