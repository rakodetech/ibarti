...
<form action="" method="post" name="add_planificacion" id="add_planificacion">
 <table width="100%" align="center">
  ...
  <td width="35%"><span id="contratacion_cont"><select id="planf_contratacion" required onchange="verificar_cont(this.value)" style="width:200px">
    <option value="">Seleccione</option></select><img class="imgLink"
    src="imagenes\ico_agregar.ico" alt="Agregar Contratacion" title="Agregar Contratacion"
    onclick="B_contratacion()" width="15px" height="15px"></span></td>
  </tr>
  <tr>
   ...
   <td width="35%"><span id="ubicacion_cont"><select id="planf_ubicacion" required  onclick="cargar_planif($('#planf_apertura').val())" style="width:200px">
     ...
     <td width="35%"><span id="apertura_cont"><select id="planf_apertura" required onclick="cargar_planif(this.value)" style="width:200px">
      <option value="">Seleccione</option></select><img class="imgLink"
      src="imagenes\ico_agregar.ico" alt="Agregar Planificacion" title="Agregar Planificacion"
      onclick="B_planif_apertura()" width="15px" height="15px"></span></td>
    </tr>
    <tr>
