...
<div id="modalRP" class="modal">
	<div class="modal-content">
		...
		<div class="modal-body">
			...
			<form action="packages/planif/planif_supervisor/views/rp_planif_serv.php" method="post" name="add_planif_serv_modal" id="add_planif_serv_modal" method="post" target="_blank">
