...
$plan   = new Planificacion;
	...
	$datos_ap    = $plan->get_planif_trab_ap($cod_pl_trab);


/*
SELECT
b.cod_ficha, b.fecha_inicio, b.fecha_fin
FROM
planif_cliente_trab_det AS a, planif_cliente_trab b
WHERE a.cod_planif_cl_trab = 59
AND a.cod_planif_cl_trab = b.codigo
AND a.cod_ficha = b.cod_ficha
GROUP BY b.cod_ficha
*/
	// $proced ="p_cal_plan_trabajador";
$periodoX = explode("-", $datos_ap["fecha_inicio"]);
