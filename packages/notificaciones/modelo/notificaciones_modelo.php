...
class Notificaciones
{
	...
	public function get_nov_notif($perfil,$usuario){
		...
		FROM nov_procesos,novedades,nov_perfiles, men_usuarios, control,nov_status,ficha,nov_procesos_det
	...
	public function get_nov_reciente($perfil,$usuario){
		...
		FROM nov_procesos,nov_procesos_det,novedades,nov_perfiles, men_usuarios, control,nov_status
		WHERE  nov_procesos.cod_novedad = novedades.codigo and nov_procesos_det.cod_nov_proc = nov_procesos.codigo AND novedades.`status` = 'T' AND 
