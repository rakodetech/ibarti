...
$proced   = "p_producto_modelo";
if($metodo == 'modificar')
{
  $titulo    = " MODIFICAR PRODUCTO MODELO (".$codigo.")";
  $prod        = $producto->editar($codigo);
}else{
  $prod   = $producto->inicio();
  $titulo    = "AGREGAR PRODUCTO MODELO";
}
$activo = $prod['status'];
?>
...
<div id="add_producto">
  <form method="post" name="add" id="add">  
    ...
    <span style="float: right;" align="center" >
      <img  style ="display: none;" border="null" width="25px" height="25px" src="imagenes/borrar.bmp" title="Borrar Registro" onclick="Borrar_producto()" id="borrar_producto_modelo" />
      <img style="display: none;" border="null" width="25px" height="25px" src="imagenes/nuevo.bmp" alt="Agregar" onclick="irAAgregarProducto()" title="Agregar Registro" id="agregar_producto_modelo" />
    ...
    <div class="TabbedPanels" id="tp1">  
     <ul class="TabbedPanelsTabGroup">   
      <li class="TabbedPanelsTab">PRODUCTO MODELO</li>
    </ul>        
