...
<form action="sc_maestros/sc_nov_clasif.php" method="post" name="add" id="add">  
 ...
 <div class="TabbedPanels" id="tp1">	
	 <ul class="TabbedPanelsTabGroup">	 
	  ...
	  <div class="TabbedPanelsContentGroup"> 
	  	 <div class="TabbedPanelsContent"><?php include('maestros/Add_nov_clasif.php');?></div>
  	  	 <div class="TabbedPanelsContent"><?php include('maestros/add_nov_clasif_ad.php');?></div>
	  </div>
 </div> 
</form>
