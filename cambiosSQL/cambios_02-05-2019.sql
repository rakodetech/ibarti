...
Date: 2019-05-02 15:44:16
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for audit_ficha
-- ----------------------------
DROP TABLE IF EXISTS `audit_ficha`;
CREATE TABLE `audit_ficha` (
  `codigo` int(11) NOT NULL AUTO_INCREMENT,
  `cod_us_ing` varchar(11) COLLATE utf8_spanish_ci DEFAULT NULL,
  `cod_ficha` varchar(11) COLLATE utf8_spanish_ci DEFAULT NULL,
  `fecha` date DEFAULT NULL,
  `hora` time DEFAULT NULL,
  PRIMARY KEY (`codigo`),
  KEY `FK_ficha` (`cod_ficha`),
  CONSTRAINT `FK_ficha` FOREIGN KEY (`cod_ficha`) REFERENCES `ficha` (`cod_ficha`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
Date: 2019-05-02 15:44:22
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for audit_ficha_det
-- ----------------------------
DROP TABLE IF EXISTS `audit_ficha_det`;
CREATE TABLE `audit_ficha_det` (
  `cod_audit` varchar(11) COLLATE utf8_spanish_ci NOT NULL,
  `campo` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
  `valor_ant` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
  `valor_new` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL
