...
SELECT
	CONCAT (clientes.nombre, "/",clientes_ubicacion.descripcion)
INTO vieja
FROM
	clientes_ubicacion,clientes
WHERE
                  clientes_ubicacion.codigo = OLD.cod_ubicacion AND clientes.codigo = clientes_ubicacion.cod_cliente
...
FROM
	clientes_ubicacion,clientes
WHERE
                  clientes_ubicacion.codigo = NEW.cod_ubicacion AND clientes.codigo = clientes_ubicacion.cod_cliente
LIMIT 1;
