...
$result01 = mysql_query(" SELECT pres_cargo_salario.codigo, pres_cargo_salario.descripcion,
                                 pres_cargo_salario.salario,  pres_cargo_salario.`status`
                            FROM pres_cargo_salario  WHERE pres_cargo_salario.codigo = ".$codigo."", $cnn);  
$row01    = mysql_fetch_array($result01);
?>
<form action="sc_maestros/<?php echo $archivo;?>.php" method="post" name="Mod" id="Mod"> 
     <table width="70%" align="center">
         <tr valign="top">                    
		     <td height="23" colspan="2" class="etiqueta_title" align="center"> MODIFICAR CARGOS Y SALARIOS </td>
         </tr>
         <tr> 
    ...
    <tr>
      ...
      <td id="input03"><input type="text" name="salario" maxlength="14" style="width:200px" value="<?php echo $row01["salario"];?>" />
