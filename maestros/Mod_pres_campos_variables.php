...
$result01 = mysql_query("SELECT pres_campos_variables.codigo, pres_campos_variables.cod_variables_tipo,
                          ...
                          WHERE pres_campos_variables.codigo = '$codigo' ", $cnn);  
...
<form action="sc_maestros/<?php echo $archivo;?>.php" method="post" name="Mod" id="Mod"> 
     <table width="70%" align="center">
         <tr valign="top">                    
		     <td height="23" colspan="2" class="etiqueta_title" align="center"> MODIFICAR CAMPOS VARIABLES </td>
         </tr>
         <tr> 
