...
$bd = new DataBase();
$archivo = "dosis_covid19";
$titulo = " VENCIMINETO DE DOSIS COVID-19 ";
...
<div id="listar">
	<table width="95%" border="0" align="center">
		...
		$sql = " SELECT ficha_dosis_covid19.codigo, ficha_dosis_covid19.descripcion,
                    Valores(ficha_dosis_covid19.vencimiento) AS vencimiento, ficha_dosis_covid19.dias,
                    ficha_dosis_covid19.`status`
               FROM ficha_dosis_covid19 ORDER BY 2 ASC ";
