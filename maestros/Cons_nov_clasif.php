...
<div id="listar"><table width="90%" border="0" align="center">
		<tr class="fondo00">
			...
			<th width="35%" class="etiqueta">Descripcion</th>
   			<th width="25%" class="etiqueta">Check List</th>
	...
	$valor = 0;
	$sql = " SELECT codigo, descripcion, Valores(campo04), status FROM $tabla ORDER BY 1 DESC ";
	...
	// $Modificar = "Add_Mod01('".$datos[0]."', 'modificar')";
	   $Borrar = "Borrar01('".$datos[0]."')";
        echo '<tr class="'.$fondo.'"> 
                  ...
                  <td class="texto">'.longitudMax($datos[1]).'</td>
				  <td class="texto">'.longitud($datos[2]).'</td>
				  <td class="texto">'.statuscal($datos[3]).'</td>
