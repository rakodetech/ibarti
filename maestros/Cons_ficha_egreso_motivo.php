...
$tabla = "ficha_egreso_motivo";
$bd = new DataBase();
$archivo = "ficha_egreso_motivo";
$titulo = " CAUSA DE EGRESO ";
...
<div id="listar">
	<table width="90%" border="0" align="center">
		<tr class="fondo00">
			...
			<th width="15%" class="etiqueta">Motivo</th>
		...
		$valor = 0;
		$sql = " SELECT codigo, motivo, descripcion, status FROM $tabla ORDER BY 2 ASC ";
