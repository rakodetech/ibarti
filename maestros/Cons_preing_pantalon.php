<?php 
	...
	$tabla = "preing_pantalon";
	$bd = new DataBase();
	$archivo = "preing_pantalon";
	$titulo = " TALLA DE PANTALON "; 
	$vinculo = "inicio.php?area=pestanas_maestro/maestros&Nmenu=$Nmenu&mod=".$_GET['mod']."&titulo=$titulo&tb=$tabla&archivo=$archivo";
?>
