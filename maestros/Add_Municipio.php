...
$id = $_GET['id'];
?>
<form action="sc_maestros/Municipio.php" method="post" name="add" id="add"> 
     <table width="70%" align="center">
         <tr valign="top">                    
		     <td height="23" colspan="2" class="etiqueta_title" align="center">
		          AGREGAR MUNICIPIO </td>
         </tr>
         <tr> 
...
-->
         ...
         <tr> 
			...
			<input type="hidden"  name="href" value="../inicio.php?area=maestros/Cons_Municipio&id=<?php echo $id;?>&Nmenu=<?php echo $_GET['Nmenu']; ?>"/>
