<form action="sc_maestros/sc_mantenimiento.php?metodo=AgregarCodigo&archivo=Componentes&tabla=componentes" method="post"   
      name="add" id="add"> 
     <table width="70%" align="center">
         <tr valign="top">                    
		     <td height="23" colspan="2" class="etiqueta_title" align="center">
		          AGREGAR COMPONENTES </td>
         </tr>
         <tr> 
    ...
    <tr>
      ...
      <td id="input02" width="75%"><input type="text" name="descripcion" maxlength="120"/>	  
        <img src="imagenes/ok.gif" alt="Valida" class="validMsg" border="0"/><br>
        <span class="textfieldRequiredMsg">La Descripcion es Requerida.</span>
		<span class="textfieldMinCharsMsg">Debe Escribir mínimo 2 Caracteres.</span></td>
    </tr>		
