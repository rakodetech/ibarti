...
if($metodo == 'modificar'){
	...
	$sql = " SELECT ficha_n_contracto.codigo, ficha_n_contracto.descripcion,
                    ficha_n_contracto.vencimiento, ficha_n_contracto.dias,
					ficha_n_contracto.campo01, ficha_n_contracto.campo02,
					ficha_n_contracto.campo03,ficha_n_contracto.campo04, 
                    ficha_n_contracto.`status`
               FROM ficha_n_contracto			   
			  WHERE ficha_n_contracto.codigo = '$codigo'";
...
var input03  = new Spry.Widget.ValidationTextField("input03", "currency", {format:"comma_dot", validateOn:["blur", "change"], useCharacterMasking:true }); 
