...
<form action="autentificacion/sc_usuarios.php" method="post" name="mod_usuarios" id="mod_usuarios"> 
  ...
  <legend><?php echo $titulo;?> </legend>
    ...
    <tr>
      ...
      <td id="input00"><input type="text" name="codigo" maxlength="11" value="<?php echo $codigo;?>"  <?php echo $disabled;?> 
...
var input00  = new Spry.Widget.ValidationTextField("input00", "none", {validateOn:["blur", "change"]});
...
var customFunction = new Spry.Widget.ValidationTextField("customPasswordFunction", "custom", {validation: passwordStrength, validateOn:["blur", "change"], isRequired:false});
var passwordDuplication = new Spry.Widget.ValidationTextField("dupFunction", "custom", {validation: passwordTheSame, validateOn:["change", "blur"], isRequired:false});
</script>