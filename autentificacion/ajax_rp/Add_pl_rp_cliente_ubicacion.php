...
$fecha_H   = conversion($_POST['fecha_hasta']);
  ...
  $sql = " SELECT pl_cliente.fecha,  regiones.descripcion AS region,
				  ...
				  turno.abrev AS turno_abrev, clientes_ubicacion.descripcion AS ubicacion,
                  horarios.nombre AS horario, cargos.descripcion AS cargo,
				  pl_cliente_det.cantidad , (pl_cliente_det.cantidad * turno.trab_cubrir) AS trab_necesario
             FROM pl_cliente , turno , horarios , pl_cliente_det ,
                  regiones , estados , clientes , clientes_ubicacion, cargos
            $where
         ORDER BY 1 ASC ";
...
<table width="100%" border="0" align="center">
		<tr class="fondo00">
            ...
            <th width="12%" class="etiqueta">Turno</th>
            <th width="23%" class="etiqueta">Cargo</th>
   ...
   $query = $bd->consultar($sql);
        ...
        echo '<tr class="'.$fondo.'">
				  ...
				  <td class="texto">'.longitud($datos["turno_abrev"]).'</td>
