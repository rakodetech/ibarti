...
$("#add_hora").on('submit', function(evt){
	 evt.preventDefault();
	 save_hora();
});
</script>
...
?>
<form action="" method="post" name="add_hora" id="add_hora">
...
<div align="center"><span class="art-button-wrapper">
             ...
             <span class="art-button-wrapper">
                    <span class="art-button-l"> </span>
                    <span class="art-button-r"> </span>
                <input type="button" id="volver" value="Volver" onClick="Cons_hora_inicio()" class="readon art-button" />
                </span>
