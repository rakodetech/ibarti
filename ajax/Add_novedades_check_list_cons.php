...
?><table width="100%" align="center">
   ...
   <tr class="fondo00"><th width="7%" class="etiqueta">Codigo</th>
		    ...
		    <th width="6%" align="center"><a href="<?php echo $vinculo."&codigo=''&metodo=agregar";?>"><img src="imagenes/nuevo.bmp" alt="Agregar Registro" title="Agregar Registro" width="20px" height="20px" border="null"/></a></td></tr>
    <?php
	$valor = 0;
