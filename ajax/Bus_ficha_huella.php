...
$bd2  = new DataBase2();
 ...
 $where  = " ";
	...
	switch ($metodo) {
		...
		case "cedula":
			$typing = $cedula;
		   $where  .= " WHERE LOCATE('$typing', ficha_huella.cedula) "; 		  			
		break;   	
		case 'huella':
		   $typing = $huella;
		   $where  .= " WHERE LOCATE('$typing',  ficha_huella.huella) "; 
        break;				
...
?><table width="99%" border="0" align="center"><tr class="fondo02">
        ...
        echo '<tr class="'.$fondo.'"> 
                  ...
                  <td td colspan="3"><input type="text" id="huella'.$i.'" style="width:450px" maxlength="120" 
				             value="'.$datos['huella'].'"/><input type="hidden" id="huella_old'.$i.'" maxlength="120" value="'.$datos['huella'].'"/></td>
