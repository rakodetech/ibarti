	...
	$sql_conceptos = "SELECT conceptos.codigo, conceptos.descripcion, conceptos.abrev
		...
		<tr class="fondo00">
			...
			<th width="6%"><img src="imagenes/loading2.gif" width="40px" height="40px"/></th>
             	 ...
             	 <td><select name="trabajador" id="trabajador" style="width:210px;">
			...
			echo'</select></td>
			  ...
			  <td><input type="decimal" value="0.00" name="horaD" id="horaD" style="width:45px" maxlength="5"/></td>
  			  <td><input type="decimal" value="0.00" name="horaN" id="horaN" style="width:45px" maxlength="5"/></td>
	   ...
	   $query = $bd->consultar($SQL_PAG);
		...
		?><tr><td colspan="6"><input type="hidden" id="apertura" name="apertura" value="<?php echo $cod_apertura;?>" />
        					   <input type="hidden" id="fec_diaria" name="fec_diaria" value="<?php echo $fec_diaria;?>" />
                           <input type="hidden" id="contracto" name="contracto" value="<?php echo $co_cont;?>" />
                           <input type="hidden" id="Nmenu" name="Nmenu" value="<?php echo $Nmenu;?>" />
                           <input type="hidden" id="mod" name="mod" value="<?php echo $mod;?>" />
                           <input type="hidden" id="rol" name="rol" value="<?php echo $cod_rol;?>" />
                           <input type="hidden" name="href"  value="../inicio.php?area=<?php echo $href;?>"/>
                           <input type="hidden" name="metodo" value="agregar"/>
                           <input type="hidden" name="usuario" id="usuario" value="<?php echo $usuario;?>"/>
                           <input type="hidden"  id="i" value="<?php echo $i;?>"/>
                           <input type="hidden"  name="ubicacion_old" value=""/>
                           <input type="hidden" name="concepto_old" value=""/>
                           <input type="hidden" name="proced" id="proced" value="p_asistencia"/></td>
		</tr></table>
