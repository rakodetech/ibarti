...
?>
	...
	<tr class="text" >
     ...
     <td width="25%" id="select_2_<?php echo $rel;?>"><select name="producto_<?php echo $rel;?>"
                     id="producto_<?php echo $rel;?>" style="width:200px;" disabled="disabled" required="required">
          <option value="">Seleccione... </option>
        </select></td>

      <td width="25%" id="select_3_<?php echo $rel;?>"><select name="almacen_<?php echo $rel;?>"
                     id="almacen_<?php echo $rel;?>" style="width:200px;" disabled="disabled" required="required">
          <option value="">Seleccione... </option>
        </select></td>
    <td width="17%" id="input04_<?php echo $rel;?>"><input type="number" name="cantida_<?php echo $rel;?>"
                                        id="cantida_<?php echo $rel;?>" required="required"/></td>
