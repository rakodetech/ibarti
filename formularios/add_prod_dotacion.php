...
<form action="sc_maestros/sc_<?php echo $archivo ?>.php" method="post" name="add" id="add">
	...
	<fieldset class="fieldset">
		...
		<table width="100%" align="left">
			<tr>
				...
				<td id="imput01" width="20%"><input type="text" name="codigo" size="15" value="<?php echo $codigo; ?>" readonly="readonly" /><br>
				...
				<td id="input02" width="20%"><input type="text" name="descripcion" maxlength="60" size="30" value="<?php echo $descripcion; ?>" /><br>
	...
	<fieldset class="fieldset" id="detalle">
		...
		<table width="100%" align="center">
			...
			<?php if ($metodo == "agregar") { ?>
				<tr class="text">
					<td id="select_1_1"><select name="linea_1" id="linea_1" style="width:150px;" onchange="ActivarSubLinea(this.value, '1', 'select_2_1')" disabled="disabled">
			...
			while ($datos = $bd->obtener_fila($query, 0)) {
				...
				?>
					<tr class="text">
						<td id="select_1_1"><select name="linea_1" id="linea_1" style="width:180px;" disabled="disabled" onchange="Activar01(this.value, '1', 'select_2_1')">
						...
						<td id="select_3_1"><select name="linea_1" id="linea_1" style="width:180px;" disabled="disabled">
						...
						<td id="input04"><input type="text" name="cantidad_1" id="cantidad_1" maxlength="15" size="15" readonly="readonly" value="<?php echo $cantidad; ?>" /></td>
						<td>&nbsp;<input type="hidden" name="relacion_1" value="1" /></td>
					</tr>
...
<script type="text/javascript">
	...
	var input04 = new Spry.Widget.ValidationTextField("input04", "real", {
		validateOn: ["blur", "change"],
		useCharacterMasking: true
	});
	...
	var select_1_1 = new Spry.Widget.ValidationSelect("select_1_1", {
		validateOn: ["blur", "change"]
	});


	function spryN(num) {
		var input04 = new Spry.Widget.ValidationTextField("input04_" + num + "", "real", {
			validateOn: ["blur", "change"],
			useCharacterMasking: true,
			isRequired: false
		});
