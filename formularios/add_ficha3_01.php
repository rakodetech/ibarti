...
if($metodo == 'modificar'){
	...
	$sql = "SELECT v_ficha.cod_ficha, v_ficha.cod_turno,
                   ...
                   v_ficha.cliente_abrev, v_ficha.cod_ubicacion,
                   v_ficha.ubicacion, v_ficha.cod_contracto,
                   v_ficha.contracto, v_ficha.cod_n_contracto,
                   v_ficha.n_contracto, v_ficha.cod_region,
...
var fecha06 = new Spry.Widget.ValidationTextField("fecha06", "date", {format:"dd-mm-yyyy", hint:"DD-MM-AAAA", 
    validateOn:["blur", "change"], useCharacterMasking:true});			
var fecha07 = new Spry.Widget.ValidationTextField("fecha07", "date", {format:"dd-mm-yyyy", hint:"DD-MM-AAAA", 
    validateOn:["blur", "change"], useCharacterMasking:true});					
