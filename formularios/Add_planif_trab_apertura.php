...
$mod = $_GET['mod'];
$titulo = "Aperturar Planificacion de ".$leng['trabajador']."";
$titulo2 = "Planificacion Actual Abierta de ".$leng['trabajador']."";
$archivo = "planif_trab_apertura";
$metodo  =$_GET['metodo'];
$href = "../inicio.php?area=formularios/Cons_$archivo&Nmenu=$Nmenu&mod=$mod";
$proced      = "p_pl_trab_apertura";
...
$sql   = " SELECT COUNT(a.codigo) cant, a.codigo, a.descripcion,
             ...
             FROM pl_trab_apertura a LEFT JOIN men_usuarios  ON a.cod_us_ing = men_usuarios.codigo
            WHERE a.`status` = 'T' ";
