       ...
       <?php
        ...
        while($datos=$bdC->obtener_fila($query1,0)){
          ...
          <tr>
              ...
              <td>
                <span class="etiqueta">Fecha </span><input class="fechaC" type="text" name="fec_<?php echo $datos["codigo"];?>" id="fec_<?php echo $datos["codigo"];?>" value="<?php echo $fecha;?>" readonly="true" size="9" border="0" width="17px"></td>
              </td>
              <td>
