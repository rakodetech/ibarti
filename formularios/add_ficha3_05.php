...
<form action="scripts/sc_ficha_05.php" method="post" name="add" id="add"> 
  ...
  <legend>Egreso Trabajador </legend>
    ...
    <tr>
      ...
      <td id="input01_5"><input type="text" name="d_p_laboral" maxlength="60" size="15" value="<?php echo $d_p_laboral;?>" /><br />
    ...
    <tr>
	 ...
	 <tr>
      ...
      <td id="fecha06_5">
          	<input type="text" name="fec_posible_pago" size="15" value="<?php if(isset($fec_posible_pago)){ echo $fec_posible_pago;}?>" /><br />
            <span class="textfieldRequiredMsg">La Fecha Es Requerida.</span>
            <span class="textfieldInvalidFormatMsg">El Formato Es Invalido</span></td>
    </tr> 
	 <tr>
