<?php
	...
	$titulo = " Apertura de Planificacion ".$leng['cliente']." ";
...
<div id="listar"><table width="98%" border="0" align="center">
	...
	$valor = 0;
	$sql = "SELECT pl_cliente_apertura.codigo, pl_cliente_apertura.fecha_inicio,
                pl_cliente_apertura.fecha_fin,
                CONCAT(a.apellido, ' ', a.nombre) us_ing, pl_cliente_apertura.fec_us_ing,
                CONCAT(b.apellido, ' ', b.nombre) us_mod, pl_cliente_apertura.fec_us_mod,
StatusD(pl_cliente_apertura.`status`) `status`
FROM pl_cliente_apertura LEFT JOIN men_usuarios a ON pl_cliente_apertura.cod_us_ing = a.codigo LEFT JOIN men_usuarios b ON pl_cliente_apertura.cod_us_mod = b.codigo
ORDER BY 1 DESC;";
