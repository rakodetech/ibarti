  ...
  <legend>DATOS ADICCIONALES <?php echo $titulo;?> </legend>
    ...
    <tr>
      ...
      <td id="campo01"><input type="text" name="campo01" id="campo01" maxlength="60" size="35"
    ...
    <tr>
      ...
      <td id="campo02"><input type="text" name="campo02" id="campo02" maxlength="60" size="35"
    ...
    <tr>
      ...
      <td id="campo03"><input type="text" name="campo03" id="campo03" maxlength="60" size="35"
    ...
    <tr>
      ...
      <td id="campo04"><input type="text" name="campo04" id="campo04" maxlength="60" size="35"
