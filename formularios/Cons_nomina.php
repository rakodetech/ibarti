...
$archivo = "nomina";
$archivo2 = "formularios/Cons_$archivo&Nmenu=$Nmenu";

$tabla   = "control";
$titulo = " APERTURA Y CIERRE DE NOMINA ";
...
<hr />
   ...
   <table width="70%" align="center">
      <tr>
        <td class="etiqueta" width="25%">Nomina:</td>
		...
		<select name="codigo" style="width:250px;" onchange="Add_ajax01(this.value, 'ajax/nomina.php','Contenedor01')">
          ...
          <option value="<?php echo $row04[0];?>"><?php echo utf8_decode($row04[1]);?></option>
          <?php }?>		
        </select>
