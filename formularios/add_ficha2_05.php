  ...
  <fieldset class="fieldset">
    ...
    <table width="80%" align="center">
      <tr>
        ...
        <td id="fecha01_5">
          	<!--<input type="text" name="fec_egreso" size="15" value="<?php //echo $fec_egreso;?>" readonly="readonly" /><br />
              ...
              <td id="radio02_5" class="texto">
                ...
                <tr>
                  ...
                  <td id="radio03_5" class="texto">
                    ...
                    style="width:auto" <?php echo CheckX($preaviso, 'S');?> disabled="disabled" />
                    No <input type = "radio" name="preaviso"  value = "N" 
                    style="width:auto" <?php echo CheckX($preaviso, 'N');?> disabled="disabled" /><br />
                  ...
                  <tr>
                   ...
                   <tr>
                    ...
                    <td id="input01_5"><input type="text" name="d_p_laboral" maxlength="60" size="15" value="<?php echo $d_p_laboral;?>" 
                      readonly="true"/><br />
                      ...
                      <tr>
                        ...
                        <tr>
                          ...
                          <tr>
                            ...
                            <td id="fecha04_5">
                             <input type="text" name="fec_calculo" size="15" value="<?php if(isset($fec_calculo)){ echo $fec_calculo;}?>" /><br />
                             <span class="textfieldRequiredMsg">La Fecha Es Requerida.</span>
                             <span class="textfieldInvalidFormatMsg">El Formato Es Invalido</span></td>
                           </tr>
                           <tr>
                            ...
                            <td id="fecha05_5">
                             <input type="text" name="fec_posible_pago" size="15" value="<?php if(isset($fec_posible_pago)){ echo $fec_pago;}?>"/><br />
                             <span class="textfieldRequiredMsg">La Fecha Es Requerida.</span>
                             <span class="textfieldInvalidFormatMsg">El Formato Es Invalido</span> </td>
                           </tr> 
                           <tr>
                            ...
                            <td id="fecha06_5">
                             <input type="text" name="fec_pago" size="15" value="<?php if(isset($fec_pago)){ echo $fec_pago;}?>" /><br />
                             <span class="textfieldRequiredMsg">La Fecha Es Requerida.</span>
                             <span class="textfieldInvalidFormatMsg">El Formato Es Invalido</span></td>
                           </tr>   
                           <tr>
                              ...
                              <tr>
                                ...
                                <tr>
                                  ...
                                  <td id="radio06_5" class="texto">
                                    ...
                                    style="width:auto" <?php echo CheckX($entrega_uniforme, 'S');?> disabled="disabled" />
                                    No <input type = "radio" name="entrega_uniforme"  value = "N" 
                                    style="width:auto" <?php echo CheckX($entrega_uniforme, 'N');?> disabled="disabled" /><br />
