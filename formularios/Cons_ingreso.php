...
function Add_filtroX(){  // CARGAR  ARCHIVO DE AJAX CON UN PARAMETRO//
	...
	ajax=nuevoAjax();
			ajax.open("POST", "ajax/Add_fic_ingreso.php", true);
...
<legend>Filtros:</legend>
	<table width="100%">
		<tr><td width="10%">Status: </td>
			...
			<td width="10%">Ex. Psicolog.:</td>
			<td width="14%"><select  name="psic" id="psic" style="width:120px;">
					<option value="TODOS">TODOS</option>
			...
			<td width="10%">Cheq. Policial:</td>
			<td width="14%"><select  name="pol" id="pol" style="width:120px;">
					<option value="TODOS">TODOS</option>
                    <option value="S"><?php echo $leng["aprobado"];?></option>
                    <option value="N"><?php echo $leng["reprobado"];?></option>
