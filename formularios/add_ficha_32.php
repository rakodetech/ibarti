...
//	require_once('autentificacion/aut_verifica_menu.php');
	$archivo = "pestanas/add_ficha&Nmenu=".$Nmenu."&codigo=".$codigo."&mod=$mod&pagina=1&metodo=modificar";
	$proced      = "p_fichas_02";
	$metodo = "modificar";						
?>
<form action="scripts/sc_ficha_02.php" method="post" name="add" id="add"> 
  <fieldset class="fieldset">
  <legend>Dotacion De Uniformes </legend>
...
<div align="center"><span class="art-button-wrapper">
            ...
            <input name="pestana" type="hidden"  value="uniforme" />
            <input name="proced" id="proced" type="hidden"  value="<?php echo $proced;?>" /> 
            <input name="usuario" type="hidden"  value="<?php echo $usuario;?>" />
		    <input name="codigo" type="hidden"  value="<?php echo $cedula;?>" />
            <input name="usuario" type="hidden"  value="<?php echo $usuario;?>" />
