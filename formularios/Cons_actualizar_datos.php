...
<fieldset>
	...
	<br />
	<form action="scripts/sc_actualizar_datos.php" method="post" name="form1" enctype="multipart/form-data" target="blank">
   <table width="70%" align="center">
	  ...
	  <tr>
		  ...
		  <td id="input01"><input type="file" name="file" size="35" accept=".csv"><br />
			<img src="imagenes/ok.gif" alt="Valida" class="validMsg" border="0"/><br>
