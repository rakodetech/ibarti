...
$Nmenu = $_GET['Nmenu'];
$mod   = $_GET['mod'];
$titulo = "PREINGRESO TRABAJADOR EXAMEN PSICOLOGICO";
$archivo2 = "../inicio.php?area=formularios/Cons_$archivo&Nmenu=$Nmenu&mod=$mod";

$proced      = "p_ingresos_exam_psic";
...
<div align="center" class="etiqueta_title"><?php echo $titulo;?> </div>
  ...
  <table width="90%" align="center">
    ...
    <tr>
      ...
      <td id="textarea02_3"><textarea  name="pol_observacion" cols="40" rows="2" disabled="disabled"><?php echo $pol_observacion;?></textarea>
...
var textarea02 = new Spry.Widget.ValidationTextarea("textarea02", {maxChars:120, validateOn:["blur", "change"], counterType:"chars_count", counterId:"Counterror_mess2", useCharacterMasking:false , isRequired:false});
