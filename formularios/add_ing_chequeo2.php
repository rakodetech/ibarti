...
?>
  ...
  <legend>Chequeo <?php echo $leng["trabajador"];?> </legend>
    ...
    <tr>
      ...
      </td><td><!--Descargar - Subir <a target="_blank" onClick="'.$subir.'"><img class="ImgLink" src="imagenes/subir.gif" width="22px" height="22px"/></a>--></td>
    </tr>
    <tr>
      <td class="etiqueta"><?php echo $leng["pol_fec"];?>:</td>
      <td><span id="fecha02_3"><input type="text" name="fec_pol" value="<?php echo $fec_pol;?>" size="12"/></span>
      </td>
	</tr>
  <tr>
     ...
     <tr>
      ...
      <td><span id="fecha03_3"><input type="text" name="fec_pre_emp" value="<?php echo $fec_pre_emp;?>" size="12"/></span>
      </td>
  </tr>
  <tr>
      ...
      <input name="pre_emp_apto" type="radio"  value="A" style="width:auto" <?php echo CheckX($pre_emp_apto, 'A');?>
                   />&nbsp;&nbsp; <?php echo $leng["reprobado"];?>
      <input name="pre_emp_apto"  type="radio" value="R" style="width:auto" <?php echo CheckX($pre_emp_apto, 'R');?>
                   />&nbsp;&nbsp; <?php echo $leng["indefinido"];?>
      <input name="pre_emp_apto"  type="radio" value="I" style="width:auto" <?php echo CheckX($pre_emp_apto, 'I');?>
                   />
      <span class="radioRequiredMsg">Seleccione...</span>
      </span>
      </td>
...
var fecha02_3 = new Spry.Widget.ValidationTextField("fecha02_3", "date", {format:"dd-mm-yyyy", hint:"DD-MM-AAAA", validateOn:["blur", "change"], useCharacterMasking:true});
var fecha03_3 = new Spry.Widget.ValidationTextField("fecha01_3", "date", {format:"dd-mm-yyyy", hint:"DD-MM-AAAA", validateOn:["blur", "change"], useCharacterMasking:true});
var fecha03_3 = new Spry.Widget.ValidationTextField("fecha03_3", "date", {format:"dd-mm-yyyy", hint:"DD-MM-AAAA", validateOn:["blur", "change"], useCharacterMasking:true});
