...
<form action="scripts/sc_<?php echo $archivo;?>.php" method="post" name="add" id="add"> 
    ...
    <tr>
      ...
      <td id="input01" width="70%"><input type="text" id="expediente" name="expediente" maxlength="60" style="width:150px" /><br />
    ...
    <tr>
      ...
      <td id="fecha01"><input type="text" name="fecha_notif" id="fecha_notif"  style="width:100px" value=""/><br />
    ...
    <tr>
      ...
      <td id="input02"><input type="text" name="titulo" maxlength="60" style="width:350px" /><br />
        <span class="textfieldRequiredMsg">El Campo es Requerido.</span>
        <span class="textfieldMinCharsMsg">Debe Escribir m&aacute;s de 4 caracteres.</span></td>
    </tr>
    <tr>
      <td class="etiqueta">Mensaje:</td>
      <td id="textarea01"><textarea  name="mensaje" cols="45" rows="3"></textarea>
	...
	<tr>
		...
		<td id="select09"><select id="paciFiltro" onchange="EstadoFiltro()" style="width:200px">
	...
	<tr>   
      ...
      <td>
		  <input  id="stdName" type="text" style="width:300px" disabled="disabled" />
	        <span id="input10"><input type="hidden" name="trabajador" id="stdID" value=""/><br /> 
...
<?php /*
    <tr>
      <td class="etiqueta">Fecha Reclamo:</td>
      <td id="fecha01"><input type="text" name="fecha"  style="width:100px" value="<?php echo $date;?>" readonly="true" />
