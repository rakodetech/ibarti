  ...
  <legend>Precio <?php echo $titulo;?> </legend>
     <table width="80%" align="center"> 	        	        
   <tr>
      <td class="etiqueta" style="width:25%">Precio Unitario 1: </td>
      <td id="input30" style="width:25%"><input type="text" name="prec_vta1" maxlength="12" style="width:120px" 
                              value="<?php echo $prec_vta1;?>"/><br />
		   <span class="textfieldRequiredMsg">El Campo es Requerido...</span>
      </td>
      <td class="etiqueta" style="width:25%">Fecha Precio 1: </td>
      <td id="fecha20" style="width:25%"><input type="text" name="fec_prec_v1" maxlength="60" style="width:120px" 
                              value="<?php echo $fec_prec_v1;?>"/><br />
		   <span class="textfieldRequiredMsg">El Campo es Requerido...</span>
      </td>
    </tr>     
   <tr>
      <td class="etiqueta">Precio Unitario 2: </td>
      <td id="input31"><input type="text" name="prec_vta2" maxlength="12" style="width:120px" 
                              value="<?php echo $prec_vta2;?>"/><br />
		   <span class="textfieldRequiredMsg">El Campo es Requerido...</span>
      </td>
      <td class="etiqueta">Fecha Precio 2: </td>
      <td id="fecha20"><input type="text" name="fec_prec_v2" maxlength="60" style="width:120px" 
                              value="<?php echo $fec_prec_v2;?>"/><br />
		   <span class="textfieldRequiredMsg">El Campo es Requerido...</span>
      </td>
    </tr>    	        	    
   <tr>
      <td class="etiqueta">Precio Unitario 3: </td>
      <td id="input32"><input type="text" name="prec_vta3" maxlength="12" style="width:120px" 
                              value="<?php echo $prec_vta3;?>"/><br />
		   <span class="textfieldRequiredMsg">El Campo es Requerido...</span>
      </td>
      <td class="etiqueta">Fecha Precio 3: </td>
      <td id="fecha20"><input type="text" name="fec_prec_v3" maxlength="60" style="width:120px" 
                              value="<?php echo $fec_prec_v3;?>"/><br />
		   <span class="textfieldRequiredMsg">El Campo es Requerido...</span>
      </td>
    </tr>    	        	    
   <tr>
      <td class="etiqueta">Precio Unitario 4: </td>
      <td id="input33"><input type="text" name="prec_vta4" maxlength="12" style="width:120px" 
                              value="<?php echo $prec_vta4;?>"/><br />
		   <span class="textfieldRequiredMsg">El Campo es Requerido...</span>
      </td>
      <td class="etiqueta">Fecha Precio 4: </td>
      <td id="fecha20"><input type="text" name="fec_prec_v4" maxlength="60" style="width:120px" 
                              value="<?php echo $fec_prec_v4;?>"/><br />
		   <span class="textfieldRequiredMsg">El Campo es Requerido...</span>
      </td>
    </tr> 
   <tr>
      <td class="etiqueta">Precio Unitario 5: </td>
      <td id="input34"><input type="text" name="prec_vta5" maxlength="12" style="width:120px" 
                              value="<?php echo $prec_vta5;?>"/><br />
		   <span class="textfieldRequiredMsg">El Campo es Requerido...</span>
      </td>
      <td class="etiqueta">Fecha Precio 5: </td>
      <td id="fecha20"><input type="text" name="fec_prec_v5" maxlength="60" style="width:120px" 
                              value="<?php echo $fec_prec_v5;?>"/><br />
		   <span class="textfieldRequiredMsg">El Campo es Requerido...</span>
      </td>
    </tr>  
	 <tr> 
