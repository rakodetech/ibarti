<?php  require_once('autentificacion/aut_verifica_menu.php'); ?>
  ...
  <legend>REFERENCIAS PERSONALES</legend>
    ...
    <td id="textarea02_2"><textarea name="refp01_observacion" cols="40" rows="2" readonly="readonly"
  ...
  <tr>
    ...
    <span class="textareaMaxCharsMsg">El maximo de caracteres permitidos es 255.</span></td>
     <td class="etiqueta">Observaci&oacute;n:</td>
    <td id="textarea04_2"><textarea  name="refp02_observacion" cols="40" rows="2" readonly="readonly"
   ...
   <tr>
    ...
    <td id="textarea06_2"><textarea  name="refp03_observacion" cols="40" rows="2"
        readonly="readonly"><?php echo $refp03_observacion;?></textarea>
  ...
  <legend>REFERENCIAS LABORALES</legend>
    ...
    <td id="textarea09_2" colspan="2"><textarea  name="refl01_observacion" cols="40" rows="2"
        readonly="readonly"><?php echo $refl01_observacion;?></textarea>
     ...
     <td id="radio04_2" colspan="2">&nbsp;&nbsp; <?php echo $leng["aceptado"];?>
			...
			<input name="refl01_apto" type="radio" value="P" style="width:auto" <?php echo CheckX($refl01_apto, 'P');?>
                   disabled="disabled"/><span class="radioRequiredMsg">Seleccione...</span>
    ...
    <td id="textarea12_2" colspan="2"><textarea  name="refl02_observacion" cols="40" rows="2"
        readonly="readonly"><?php echo $refl02_observacion;?></textarea>
