...
$status     = $_POST['status'];
	...
	if($status != "TODOS"){
		...
		$sql   = " SELECT nov_check_list.codigo, nov_check_list.fec_us_ing,
						  ...
						  CONCAT(preingreso.apellidos, ' ', preingreso.nombres) AS trabajador, nov_status.descripcion AS nov_status               FROM nov_check_list LEFT JOIN men_usuarios ON nov_check_list.cod_us_mod = men_usuarios.codigo ,
...
?><table width="100%" align="center">
   <tr class="fondo00">
			...
			<th width="22%" class="etiqueta">Clasificacion</th>
  			<th width="25%" class="etiqueta"><?php echo $leng['cliente']?></th>
