...
$sql  = " SELECT men_usuarios.login  FROM men_usuarios
...
<form action="autentificacion/sc_usuarios.php" method="post" name="mod_usuarios" id="mod_usuarios"> 
	...
	<tr>
      ...
      <td id="input01"><input name="login" type="text" maxlength="15" style="width:120px" readonly="true"
                              value="<?php echo $row01["login"];?>" ><br />
    ...
    <tr>
      ...
      <td id="input02"><input name="passOLD"  type="password" style="width:120px" maxlength="10"><br />
          	<span class="textfieldRequiredMsg">El Valor es Requerido.</span>
          	<span class="textfieldMinCharsMsg">Debe Escribir mas de 3 caracteres.</span>
	  </span>
	  </td>
    </tr>	   
    <tr>
      <td class="etiqueta">Clave Nueva:</td>
      <td id="customPasswordFunction"><input name="password1" id="password1" type="password" style="width:120px" maxlength="10"><br />
          	<span class="textfieldRequiredMsg">El Valor es Requerido.</span>
    ...
    <tr>
      ...
      <td id="dupFunction"><input name="password2" id="password2" type="password" style="width:120px" maxlength="10"><br />
          	<span class="textfieldRequiredMsg">El Valor es Requerido.</span>
