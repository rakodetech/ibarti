...
function Add_filtroX(){  // CARGAR  ARCHIVO DE AJAX CON UN PARAMETRO //
    ...
    var errorMessage = ' ';
	 ...
	 if(error == 0){
		...
		ajax=nuevoAjax();
			ajax.open("POST", "ajax/Add_pl_trabajador.php", true);
			...
			ajax.send("&rol="+rol+"&region="+region+"&estado="+estado+"&contrato="+contrato+"&cargo="+cargo+"&cliente="+cliente+"&ubicacion="+ubicacion+"&turno="+turno+"&usuario="+usuario+"");	
	...
	<table width="100%">
       <tr> 
		...
		<td width="14%" id="select01"><select name="rol" id="rol" style="width:120px;" onchange="Add_filtroX()">
		 ...
		 <td width="14%"><select name="region" id="region" style="width:120px;" onchange="Add_filtroX()">
			...
			<td width="14%"><select name="estado" id="estado" style="width:120px;" onchange="Add_filtroX()">
					<option value="TODOS">TODOS</option>
					<?php 
        ...
        <tr> 
		 <td>Contrato: </td>
			<td><select name="contrato" id="contrato" style="width:120px;" onchange="Add_filtroX()">
					<option value="TODOS">TODOS</option> 
					<?php 
		 ...
		 <td>Ubicacion: </td>
			<td id="contenido_ubic"><select name="ubicacion" id="ubicacion" style="width:120px;" onchange="Add_filtroX()">
					    <option value="TODOS">TODOS</option> 
				</select></td>           
      </tr>  
        <tr>
		 ...
		 <td>Turno: </td>
		<td><select name="turno" id="turno" style="width:120px;" onchange="Add_filtroX()">
					    <option value="TODOS">TODOS</option> 
					<?php 
        ...
        <td><span class="art-button-wrapper">
            ...
            <input type="submit" name="descarga" id="descarga" value="Descarga" class="readon art-button"
            onmousedown="Add_form('reportes/rp_plantilla_trabajador_det.php?<?php echo $men;?>', '_blank')" 
             onmouseout="Add_form('sc_maestros/sc_<?php echo $archivo;?>.php?<?php echo $men;?>', '_self')">  
        </span> </td>
        <td>&nbsp; 
