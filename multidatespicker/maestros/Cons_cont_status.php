...
<div id="listar"><table width="90%" border="0" align="center">
		<tr class="fondo00">
		    ...
		    <th width="15%" align="center"><a href="<?php echo $vinculo."&codigo=''&metodo=agregar";?>">
            <img src="imagenes/nuevo.bmp" alt="Agregar" title="Agregar Registro" width="30px" height="30px" border="null"/></a></th> 
		</tr>
    <?php       
