<?php
/*
»» Si tocas mi codigo... lavate las manos primero ;)
  ...
  <tr>
    <?php
			...
			foreach($campos as $etiquetas => $muestraCampos){
            	echo '<td><a href="'.$url.'orden='.$campos[$etiquetas].'&pag='.$pag.'" class"etiqueta">'.$etiquetas.'</a></td>';
			}
			
			echo '<td width="80" align="center" valign="middle"><a href="'.$hrefAgregar.'"><img src="../images/add03.gif" alt="Agregar"  border="null" title="Agregar Registro" /> | </a>
				  <a href="'.$hrefBuscar.'"><img src="../images/buscar02.gif" alt="Buscar"  border="null" title="Buscar Registro" />
			</td>
    ...
    <?php }
				...
				echo '<td align="center" valign="middle"><a href="'.$hrefModificar.'&campoClave='.$row[0].'"> <img src="../images/edit03.gif" alt="Modificar" border="null" title="Modificar Registro" /> </a> | <a href="'.$hrefEliminar.'?campoClave='.$row[0].'&archivo=eliminar'.'"> <img src="../images/eliminar.gif" alt="Eliminar"  border="null" title=" Eliminar Registro"/> </a></td>';
