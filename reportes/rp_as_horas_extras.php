...
?>
<br>
<div align="center" class="etiqueta_title"> REPORTE HORAS EXTRAS <BR /></div>
<div id="Contendor01" class="mensaje"></div>
<br/>
<form id="form" name="form" action="reportes/rp_as_horas_extras_det.php?Nmenu=<?php echo $Nmenu?>" method="post" target="_blank">
  <table width="750px" border="0" align="center">
    ...
    <tr>
		...
		<td  id="select03">
			   <select name="cliente" style="width:250px;">
     				   <option value="TODOS"> TODOS</option>
					   <?php
					    $query03 = mysql_query("SELECT co_cli, cli_des FROM clientes ORDER BY 2", $cnn);
