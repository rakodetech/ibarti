...
?>
<br>
<div align="center" class="etiqueta_title"> REPORTE CUMPLIMIENTO DE ASISTENCIA <BR /></div>
<div id="Contendor01" class="mensaje"></div>
<br/>
<form id="clientes" name="clientes" action="reportes/rp_asistencia_det.php?Nmenu=<?php echo $Nmenu?>" method="post" target="_blank">
			   ...
			   <select name="contracto" style="width:250px;">
					   ...
					   <?php
					    $query03 = mysql_query("SELECT nomina.co_cont, nomina.des_cont
						   FROM nomina WHERE nomina.tip_cont = 2  ORDER BY 2", $cnn);
