...
$titulo  = " Reporte ".$leng['trabajador']." ".$leng['ci']."";
$archivo = "reportes/rp_fic_cedula_det.php?Nmenu=$Nmenu&mod=$mod";
...
function Add_filtroX(){  // CARGAR  ARCHIVO DE AJAX CON UN PARAMETRO //
	...
	if(error == 0){
		...
		ajax=nuevoAjax();
			ajax.open("POST", "ajax_rp/Add_fic_cedula.php", true);
			...
			ajax.send("rol="+rol+"&contrato="+contrato+"&estado="+estado+"&ciudad="+ciudad+"&cargo="+cargo+"&cedula="+cedula+"&trabajador="+trabajador+"&status="+status+"");
...
<hr /><table width="100%" class="etiqueta">
	...
	<tr>
    	...
    	<td>Cargo: </td>
         ...
         <td><?php echo $leng['ci']?>:</td>
		<td><select name="cedula" id="cedula" style="width:120px;">
     		        <option value="TODOS"> TODOS</option>
...
<div align="center"><br/>
        ...
        <img class="imgLink" id=img_pantalla src="imagenes/pdf.gif" border="0" 
        onclick="{$('#reporte').val('pdf');$('#procesar').click();}" width="25px" title="visualizar en pdf">
