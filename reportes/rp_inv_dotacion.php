...
function Add_filtroX(){  // CARGAR  ARCHIVO DE AJAX CON UN PARAMETRO //
	...
	if(error == 0){
		...
		ajax=nuevoAjax();
			ajax.open("POST", "ajax_rp/Add_inv_dotacion.php", true);
			...
			ajax.send("rol="+rol+"&linea="+linea+"&sub_linea="+sub_linea+"&producto="+producto+"&anulado="+anulado+"&trabajador="+trabajador+"&fecha_desde="+fecha_desde+"&fecha_hasta="+fecha_hasta+"");
