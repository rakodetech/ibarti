...
?>
<br>
<div align="center" class="etiqueta_title"> Reporte Asistencia <?php echo $leng['concepto']?> <BR /></div>
<div id="Contendor01" class="mensaje"></div>
<br/>
<form id="reportes" action="reportes/rp_asistencia_conceptos_det.php?Nmenu=<?php echo $Nmenu?>" method="post" target="_blank">
