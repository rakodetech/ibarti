...
if (isset($reporte)) {
    ...
    if ($reporte == 'excel') {
		...
		<th>Cod. Cliente</th><th>Abrev. Cliente</th><th> " . $leng['cliente'] . "  </th><th>Cod. " . $leng['ubicacion'] . " </th><th> " . $leng['ubicacion'] . "  </th> <th> Cantidad </th> <th> Contratacion </th> <th> Diferencia </th></tr>";

        while ($row01 = $bd->obtener_num($query01)) {
            echo "<tr><td>" . $row01[0] . "</td><td>" . $row01[1] . "</td><td>" . $row01[2] . "</td><td>" . $row01[3] . "</td>
			<td>" . $row01[4] . "</td><td>" . $row01[5] . "</td><td>" . $row01[6] . "</td><td>" . $row01[7] . "</td><td>" . $row01[8] . "</td><td>" . $row01[9] . "</td></td><td>" . $row01[10] . "</td></td><td>" . $row01[11] . "</td><td>" . $row01[12] . "</td></tr>";
        }
        echo "</table>";
    }
    if ($reporte == 'pdf') {
