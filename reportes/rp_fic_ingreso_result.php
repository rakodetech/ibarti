...
$Nmenu   = 530;
$mod     =  $_GET['mod'];
$titulo  = " REPORTE INGRESO RESULTADO TRABAJADORES ";
$archivo = "reportes/rp_fic_ingreso_result_det.php?Nmenu=$Nmenu&mod=$mod";
...
function Add_filtroX(){  // CARGAR  ARCHIVO DE AJAX CON UN PARAMETRO //
	...
	if(error == 0){
		...
		$.ajax({
			data:  parametros,
			url:   'ajax_rp/Add_fic_ingreso_result.php',
			type:  'post',
			beforeSend: function () {
