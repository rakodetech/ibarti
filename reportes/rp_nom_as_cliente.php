...
<?php
	$Nmenu   = 542;
	$mod     =  $_GET['mod'];
	$titulo  = " REPORTE RESUMEN DE ASISTENCIA POR CLIENTE ";
	$archivo = "reportes/rp_nom_as_cliente_det.php?Nmenu=$Nmenu&mod=$mod";
...
function Add_filtroX(){  // CARGAR  ARCHIVO DE AJAX CON UN PARAMETRO //
	...
	if(error == 0){
		...
		ajax=nuevoAjax();
			ajax.open("POST", "ajax_rp/Add_nom_as_cliente.php", true);
