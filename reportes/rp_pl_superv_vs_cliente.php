...
$bd = new DataBase();
$archivo = "reportes/rp_pl_superv_vs_cliente_det.php?Nmenu=$Nmenu&mod=$mod";
$titulo = "Semaforo Planificacion Supervisión";
?>
...
<script language="JavaScript" type="text/javascript">
    function Add_filtroX() { // CARGAR  ARCHIVO DE AJAX CON UN PARAMETRO //
        ...
        if (error == 0) {
            ...
            $.ajax({
                data: parametros,
                url: 'ajax/Add_planif_superv_vs_cliente.php',
                type: 'post',
