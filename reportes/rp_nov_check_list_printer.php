...
if (isset($metodo)) {
	...
	// QUERY A MOSTRAR //
	$sql = "SELECT nov_check_list.hora,  nov_check_list.fec_us_ing AS fec_sistema,
	...
	if ($metodo == 'printer') {
		...
		echo "<TR><TH colspan='2'>$titulo </TH></TR>
			      ...
			      <tr><td>Fecha De Sistema: " . $row01['fec_sistema'] . "</td><td>Hora De Ingreso: " . $row01['hora'] . "</td></tr>
