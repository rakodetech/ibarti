...
?>
<br>
<div align="center" class="etiqueta_title"> REPORTE ANALIS DE HOMBRES PRODUCTOS <BR /><BR /></div>
<div id="Contendor01" class="mensaje"></div>
<br/>
<form id="clientes" name="clientes" action="reportes/rp_as_homb_prod_det.php?Nmenu=<?php echo $Nmenu?>" method="post" target="_blank">
