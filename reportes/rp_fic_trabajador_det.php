...
if (isset($reporte)) {
	...
	v_ficha.fec_ingreso, ficha_egreso_motivo.descripcion motivo_egreso, v_ficha.fec_profit, v_ficha.fec_contracto, ficha_egreso.fec_egreso, ficha_egreso_motivo.descripcion motivo_egreso,
