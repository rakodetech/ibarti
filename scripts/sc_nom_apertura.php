...
$href     = $_POST['href'];
 ...
 $sql    = "SELECT COUNT( asistencia_cierre.`status`) AS cerrada 
              FROM asistencia_apertura, asistencia_cierre, ficha, control,
			       trab_roles, roles
             WHERE asistencia_apertura.cod_contracto = '$codigo'
               ...
               AND asistencia_apertura.cod_contracto = ficha.cod_contracto
               AND ficha.cod_ficha_status = control.ficha_activo
               AND ficha.cod_ficha = trab_roles.cod_ficha
               AND asistencia_cierre.cod_rol = trab_roles.cod_rol
