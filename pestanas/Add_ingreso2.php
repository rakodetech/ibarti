 ...
 <div class="TabbedPanels" id="tp1">
	 <ul class="TabbedPanelsTabGroup">
	  ...
	  <div class="TabbedPanelsContentGroup">
         ...
         <div class="TabbedPanelsContent"><?php include('formularios/add_ing_chequeo2.php');?></div>
  	  	 <div class="TabbedPanelsContent"><?php include('formularios/add_ing_referencia2.php');?></div>
