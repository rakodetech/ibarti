<?php   
   require('../../autentificacion/aut_config.inc.php');
	...
	switch ($filtro) {
		...
		case codigo:
		   $where  .= " WHERE LOCATE('$typing', codigo) "; 		  
		break;
		case descripcion:
    ...
    $result = mysql_query("SELECT codigo, descripcion, campo01, campo02, campo03, campo04, campo05, campo06, status FROM $tab ".$where."", $cnn);
